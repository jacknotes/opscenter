<template>
  <div>
    <el-card class="main-card">
      ...
      <el-table :data="users" stripe border :row-class-name="({ row }) => row.enabled === false ? 'disabled-row' : ''" @selection-change="handleSelectionChange" ref="tableRef" v-force-reflow>
